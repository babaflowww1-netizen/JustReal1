...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body { 
            background: #0b0f19 url('https://images.unsplash.com/photo-1559526324-4b87b5e36e44?q=80&w=1000&auto=format&fit=crop') no-repeat center center fixed;
        ...
        .wide-check-card { width: 100%; padding: 18px; background: var(--card-bg); border-radius: 14px; border: 1px solid rgba(139, 92, 246, 0.4); margin-top: 14px; }
