...
def init_db():
    ...
    # Güncellenmiş Admin Bilgileri: JustReal07 / JustReal2026*
    try:
        ...
        # Eğer kullanıcı daha önceden varsa direkt Admin yap ve şifresini güncelle
                    ...
                    if message and "text" in message:
                        ...
                        if text.startswith("/start"):
                            ...
                            if not is_member:
                                welcome_msg = (
                                    f"👋 Merhaba {user_name}!\n\n"
                                    "🚨 **JustReal Multi-Checker** sistemini kullanabilmek için öncelikle resmi kanalımıza katılman gerekmektedir.\n\n"
                                    "👉 Lütfen kanalımıza katıldıktan sonra tekrar `/start` komutuna bas."
                                )
                                keyboard = {
                                    "inline_keyboard": [
